...
- **Pro** ($15/month): A/B testing, email capture, advanced triggers
- **Advanced** ($25/month): Full analytics, integrations, unlimited popups

### Value Proposition

- **For Store Owners**: Recover lost sales, increase conversion rates by 15-25%
- **Easy Setup**: Configure in minutes, no coding required
- **Proven Results**: Exit-intent popups typically see 7-15% conversion rates
